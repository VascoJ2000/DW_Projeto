...
const addUserNight = "INSERT INTO user_nights (user_id, movie_night_id, confirm, night_host) VALUES ($1, $2, $3, $4)";
const updateConfirmation = "UPDATE user_nights SET confirm = $1 WHERE user_id = $2 AND movie_night_id = $3";
